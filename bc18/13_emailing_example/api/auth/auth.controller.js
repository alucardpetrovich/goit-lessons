...
import { Conflict, Unauthorized, NotFound } from "../helpers/errorConstructors";
...
export class AuthController {
  ...
  async signIn(req, res, next) {
    try {
      ...
      if (!user || user.status !== USER_STATUSES.VERIFIED) {
  ...
  async sendVerificationEmail(user) {
    ...
    const verificationLink = `${process.env.SERVER_URL}/auth/verify?verificationToken=${verificationToken}`;
